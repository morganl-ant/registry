...
describe("claude-code", async () => {
  ...
  test("happy-path", async () => {
    ...
    const installLog = await readFileContainer(
      id,
      "/home/coder/.coder-modules/coder/claude-code/install.log",
    );
  ...
  test("pre-post-install-scripts", async () => {
    ...
    const preInstallLog = await readFileContainer(
      id,
      "/home/coder/.coder-modules/coder/claude-code/pre_install.log",
    );
    expect(preInstallLog).toContain("claude-pre-install-script");

    const postInstallLog = await readFileContainer(
      id,
      "/home/coder/.coder-modules/coder/claude-code/post_install.log",
    );
